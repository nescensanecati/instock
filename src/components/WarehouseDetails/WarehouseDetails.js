      ...
      <section id="warehouse-details">
        <section className="warehouse-details__h1-container">
          <div className="warehouse-details__back-button">
            ...
            <h1 className="warehouse-details__h1">Washington</h1>
          </div>
        ...
        <section className="warehouse-details__details-container">
          ...
          <div className="warehouse-details__contact-container">
            <div id="contact-name">
              ...
              <div>
                <p className="warehouse-details__p2">Graeme Lyon</p>
                <p className="warehouse-details__p2">Warehouse Manager</p>
              </div>
            </div>
            <div>
              <div className="warehouse-details__contact-details-container">
                <h4 className="warehouse-details__h4">CONTACT INFORMATION:</h4>
              </div>
              <div>
                <p className="warehouse-details__p2">(747) - 222 - 2222 </p>
                <p className="warehouse-details__p2">gylon@Instock.com</p>
              </div>
            </div>
          </div>
        </section>
